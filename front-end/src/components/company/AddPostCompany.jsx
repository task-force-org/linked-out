...
const AddPostCompany = () => {
  ...
  return (
    <>
      ...
      <input
        type="text"
        placeholder="Enter the Post_title"
        onChange={(e) => setPost_title(e.target.value)}
      />
      <br />
      <input
        type="file"
        placeholder="Enter the post_img"
        onChange={(e) => handlePic(e)}
      />
      <br />
      <input
        type="text"
        placeholder="Enter the post_description"
        onChange={(e) => setPost_description(e.target.value)}
      />
      <br />
      <input
        type="text"
        placeholder="Enter the post_details"
        onChange={(e) => setPost_details(e.target.value)}
      />
      <br />
      <button className="button" type="submit" onClick={handleAddPost}>
        Submit
      </button>
    </>
  );
