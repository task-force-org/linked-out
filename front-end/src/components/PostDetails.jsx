    ...
    <div>
      <div class="card">
        <div
          class="card-body"
          onClick={() =>
            navigate("/companyDetails", { state: { id: onePost.idcompany } })
          }
        >
          {" "}
          <img src={onePost.img} class="img" alt="..." />
          <h5
            class="card-title"
            onClick={() =>
              navigate("/companyDetails", { state: { id: onePost.idcompany } })
          ...
          >
            {onePost.company_name}
          </h5>
          <p class="card-text">
            <small class="text-muted">{onePost.post_date}</small>
          </p>
        </div>
      </div>
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            <small class="text-muted">number of appliers {app.length}</small>
          </p>
        </div>
        <Button variant="primary" onClick={(event) => postApplication(event)}>
          Apply
        </Button>
      </div>
    </div>
